...
describe('getDownloadCounterReportTypes', () => {
  it('should return correct values for release 4 and report JR1', () => {
    const expectedValues = [{ value: 'JR1 (4)', label: 'JR1 (4)', release: '4', reportType: 'JR1' }];
  ...
  it('should return correct values for release 5 and report DR', () => {
    const expectedValues = [
      { value: 'DR (5)', label: 'DR (5)', release: '5', reportType: 'DR' },
      { value: 'DR_D1 (5)', label: 'DR_D1 (5)', release: '5', reportType: 'DR_D1' },
    ];
  ...
  it('should return correct values for release 5.1 and report DR', () => {
    const expectedValues = [
      { value: 'DR (5.1)', label: 'DR (5.1)', release: '5.1', reportType: 'DR' },
      { value: 'DR_D1 (5.1)', label: 'DR_D1 (5.1)', release: '5.1', reportType: 'DR_D1' },
      { value: 'DR_D2 (5.1)', label: 'DR_D2 (5.1)', release: '5.1', reportType: 'DR_D2' },
    ];
